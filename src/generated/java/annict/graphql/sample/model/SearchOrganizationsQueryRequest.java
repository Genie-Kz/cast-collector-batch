...
public class SearchOrganizationsQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "searchOrganizations";
    ...
    public SearchOrganizationsQueryRequest() {
    }

    public SearchOrganizationsQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public void setOrderBy(OrganizationOrder orderBy) {
    ...
    public static SearchOrganizationsQueryRequest.Builder builder() {
        return new SearchOrganizationsQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        private OrganizationOrder orderBy;
        ...
        public Builder setOrderBy(OrganizationOrder orderBy) {
            this.orderBy = orderBy;
            return this;
        }


        public SearchOrganizationsQueryRequest build() {
            SearchOrganizationsQueryRequest obj = new SearchOrganizationsQueryRequest($alias);
            obj.setAfter(after);
