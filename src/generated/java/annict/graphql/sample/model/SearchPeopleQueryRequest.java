...
public class SearchPeopleQueryRequest implements GraphQLOperationRequest {

    public static final String OPERATION_NAME = "searchPeople";
    ...
    public SearchPeopleQueryRequest() {
    }

    public SearchPeopleQueryRequest(String alias) {
        this.alias = alias;
    }
    ...
    public void setOrderBy(PersonOrder orderBy) {
    ...
    public static SearchPeopleQueryRequest.Builder builder() {
        return new SearchPeopleQueryRequest.Builder();
    }
    ...
    public static class Builder {
        ...
        public Builder setOrderBy(PersonOrder orderBy) {
            this.orderBy = orderBy;
            return this;
        }


        public SearchPeopleQueryRequest build() {
            SearchPeopleQueryRequest obj = new SearchPeopleQueryRequest($alias);
            obj.setAfter(after);
